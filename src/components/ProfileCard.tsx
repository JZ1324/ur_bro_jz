      ...
      <div className="relative z-10 flex w-full max-w-[24rem] min-w-0 flex-col items-center gap-3 justify-self-center text-center">
        ...
        <div className="mt-1 flex w-full max-w-[20.5rem] gap-3">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex-1 rounded-full bg-accent px-5 py-2 text-center text-[0.95rem] font-semibold text-bg shadow-lg shadow-accent/10 premium-transition hover:bg-accent-dark active:scale-95"
          >
            Instagram
          </a>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex-1 rounded-full border border-warm-accent/45 bg-warm-accent/10 px-5 py-2 text-center text-[0.95rem] font-semibold text-text shadow-sm premium-transition hover:bg-warm-accent/15 active:scale-95"
          >
