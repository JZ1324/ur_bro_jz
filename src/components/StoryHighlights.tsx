...
export function StoryHighlights({ stories, isUnlocked, lockedPulseId, onStoryClick }: StoryHighlightsProps) {
  return (
    <motion.section
      ...
      className="w-full"
    >
      <div className="overflow-x-auto px-1 scrollbar-hide sm:px-2">
        <div className="mx-auto flex w-max min-w-full justify-center gap-3.5 py-3 sm:gap-5 md:gap-6 md:py-4">
          {stories.map((story) => {
