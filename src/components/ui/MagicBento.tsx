...
const ParticleCard: React.FC<{
  ...
  useEffect(() => {
    ...
    element.addEventListener('click', handleClickInteraction);
    ...
    return () => {
      ...
      element.removeEventListener('click', handleClickInteraction);
      clearAllParticles();
    };
    ...
    <>
      ...
      <BentoCardGrid gridRef={gridRef}>
        {data.map((card, index) => {
          ...
          const handleInteraction = (el: HTMLElement | null) => {
            if (!el) return;
            ...
            el.addEventListener('click', handleClickInteraction);
          };
