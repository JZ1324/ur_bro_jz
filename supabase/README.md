...
supabase secrets set SECRET_PUZZLE_FRAGMENT_HASH="paste-base64-payload-hash-here"
supabase secrets set SECRET_PUZZLE_PAYLOAD_HASH="paste-hex-payload-hash-here"
supabase secrets set SECRET_PUZZLE_HEX_HASH="paste-normalized-cipher-line-hash-here"
...
The sealed-note puzzle is `fragment -> payload -> hex -> cipher -> reveal`.
The hashes should be generated from the normalized answer for each step. Do not commit the real puzzle answers, hashes, or the final name.
